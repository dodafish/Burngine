...
/*
 * NOTE: This file is modified to fit Burngine's environment. (namespace, declarations, etc.)
 */

#ifndef INCLUDE_BURNGINE_SYSTEM_UTF_HPP_
#define INCLUDE_BURNGINE_SYSTEM_UTF_HPP_
////////////////////////////////////////////////////////////
// Headers
////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
		...
		static Out encode(	Uint32 input,
							Out output,
							Uint8 replacement = 0);
		////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
		template<typename In>
		static std::size_t count(	In begin,
									In end);
		////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
		template<typename In, typename Out>
		static Out fromLatin1(	In begin,
								In end,
								Out output);
		////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
		template<typename Out>
		static Out encodeWide(	Uint32 codepoint,
								Out output,
								wchar_t replacement = 0);
	};
#include <Burngine/System/Utf.inl>
// Make typedefs to get rid of the template syntax
	typedef Utf<8> Utf8;
	typedef Utf<16> Utf16;
	typedef Utf<32> Utf32;
}    // namespace sf
#endif // INCLUDE_BURNGINE_SYSTEM_UTF_HPP_
////////////////////////////////////////////////////////////
/// \class burn::Utf
/// \ingroup system
///
...
///
/// burn::Utf is a low-level, generic interface for counting, iterating,
...
///
/// burn::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li burn::Utf<8> (typedef'd to burn::Utf8)
/// \li burn::Utf<16> (typedef'd to burn::Utf16)
/// \li burn::Utf<32> (typedef'd to burn::Utf32)
///
///////////////////////////////////////////////////////////
