 ...
 */
enum {
	PTW32_FALSE = 0, PTW32_TRUE = (!PTW32_FALSE)
};
...
#   include     <sys/types.h>
	...
	enum {
		 ...
		 */
		PTHREAD_INHERIT_SCHED = 0, PTHREAD_EXPLICIT_SCHED = 1, /* Default */

		/*
		 * pthread_{get,set}scope
		 */
		PTHREAD_SCOPE_PROCESS = 0, PTHREAD_SCOPE_SYSTEM = 1, /* Default */
		 ...
		 */
		PTHREAD_CANCEL_ASYNCHRONOUS = 0, PTHREAD_CANCEL_DEFERRED = 1, /* Default */
...
#error ERROR [__FILE__, line __LINE__]: Cleanup type undefined.
	...
	PTW32_DLLPORT int PTW32_CDECL pthread_mutexattr_setrobust(	pthread_mutexattr_t *attr,
																int robust);
	PTW32_DLLPORT int PTW32_CDECL pthread_mutexattr_getrobust(	const pthread_mutexattr_t * attr,
																int * robust);
